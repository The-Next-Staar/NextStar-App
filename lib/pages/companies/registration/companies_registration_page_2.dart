...
import 'companies_registration_page_3.dart';

class CompaniesRegistrationPage2 extends StatefulWidget {
  @override
  _CompaniesRegistrationPage2State createState() =>
      _CompaniesRegistrationPage2State();
}

class _CompaniesRegistrationPage2State
    extends State<CompaniesRegistrationPage2> {
        ...
        onTap: () {
          if (_idController.text.isEmpty ||
            ...
            Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => CompaniesRegistrationPage3()),
            );
          }
        },
        child: Container(
