...
class IndividualsRegistrationPage1 extends StatefulWidget {
  @override
  _IndividualsRegistrationPage1State createState() =>
      _IndividualsRegistrationPage1State();
}

class _IndividualsRegistrationPage1State
    extends State<IndividualsRegistrationPage1> {
        ...
        onTap: () {
          if (_nameController.text.isNotEmpty &&
            ...
            Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => IndividualsRegistrationPage2()),
            );
          } else {
